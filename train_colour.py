...
save_path = "GAN_Sat_image_grey_100.h5" #path to save model
path = "/kaggle/working/maps/train/" #path to load training data, only directory name required
...
#for better result use 300 epochs 
fit(data, 100)
